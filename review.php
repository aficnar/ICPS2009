...
<p><strong><img src="images/uvodnik.gif" width="13" height="13"><a href="statistics.php" target="_blank"> 
  Database statistics</a></strong><br>
  <br>
...
$sirina=$_SESSION['list'][1]*20+$_SESSION['list'][2]*100+$_SESSION['list'][3]*100+$_SESSION['list'][4]*20+$_SESSION['list'][5]*150+
